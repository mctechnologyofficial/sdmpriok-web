        ...
        <div class="card custom-card mg-b-20">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    @endif
                    <div>
                        <h6 class="main-content-label mb-1">Edit Competency</h6>
                    ...
                    <div class="">
                        <form action="{{ route('competency.update', $competency->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row row-xs align-items-center mg-b-20 category-name">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="Enter category name" type="text" name="category" value="{{ $competency->category }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20 sub-category-name">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="Enter sub category name" type="text" name="sub_category" value="{{ $competency->sub_category }}">
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-8">
                                    <img src="{{ asset($competency->image) }}" alt="..." class="img-thumbnail w-50" id="image">
                                </div>
                            </div>
