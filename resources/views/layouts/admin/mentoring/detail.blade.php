        ...
        <script>
            $(document).ready(function(){
                ...
                $(document).on('click', '#subcategory', function(){
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getcategoryspv',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                        ...
                        success: function(response){
                            ...
                            $.ajax({
                                url: '/admin/monitoring/getquestionspv',
                                type: 'GET',
                                data: {
                                    _token: CSRF_TOKEN,
                ...
                $(document).on('click', '#btnLihat', function(){
                    $.ajax({
                        url: '/admin/monitoring/getanswerspv',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            userid: $('#userid').val(),
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getcommentspv',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getevaluationspv',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            questionid: questionid,
                ...
                $(document).on('click', '#postcomment', function(){
                    $.ajax({
                        type:"POST",
                        url: "{{ route('monitoring-spv.postcomment') }}",
                        data: {
                            _token: CSRF_TOKEN,
                            competencyid: $('#competencyid').val(),
                            questionid: questionid,
                ...
                $(document).on('click', '#saveresult', function(){
                    $.ajax({
                        type:"POST",
                        url: "{{ route('monitoring-spv.saveevaluation') }}",
                        data: {
                            _token: CSRF_TOKEN,
                            competencyid: $('#competencyid').val(),
                            questionid: questionid,
        ...
        <script>
            $(document).ready(function(){
                ...
                $(document).on('click', '#subcategory', function(){
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getquestionop',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            reference: value
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getcompetencyidop',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            sub_category: value
                ...
                $(document).on('click', '#btnLihat', function(){
                    $.ajax({
                        url: '/admin/monitoring/getanswerop',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            userid: $('#userid').val(),
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getcommentop',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            competencyid: $('#competencyid').val(),
                    ...
                    $.ajax({
                        url: '/admin/monitoring/getevaluationop',
                        type: 'GET',
                        data: {
                            _token: CSRF_TOKEN,
                            questionid: questionid,
                ...
                $(document).on('click', '#postcomment', function(){
                    $.ajax({
                        type:"POST",
                        url: "{{ route('monitoring-op.postcomment') }}",
                        data: {
                            _token: CSRF_TOKEN,
                            competencyid: $('#competencyid').val(),
                            questionid: questionid,
                ...
                $(document).on('click', '#saveresult', function(){
                    $.ajax({
                        type:"POST",
                        url: "{{ route('monitoring-op.saveevaluation') }}",
                        data: {
                            _token: CSRF_TOKEN,
                            competencyid: $('#competencyid').val(),
                            questionid: questionid,
