                                ...
                                <div class="row row-xs align-items-center mg-b-20">
                                    ...
                                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                                        <select name="role_id" class="form-control">
                                            <option value=""
                                                @if ($user->roles->first() == null) selected disabled @endif>Choose position
                                            </option>
                                            @foreach ($role as $roles)
                                                <option value="{{ $roles->id }}"
                                                    @if ($user->roles->first()->id == $roles->id) selected @endif>{{ ucfirst($roles->name) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row row-xs align-items-center mg-b-20">
                                    ...
                                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                                        <select name="team_id" class="form-control">
                                            <option value=""
                                                @if ($user->id == '') selected disabled @endif>Choose team
                                            </option>
                                            @foreach ($team as $teams)
                                                <option value="{{ $teams->id }}"
                                                    @if ($user->team_id == $teams->id) selected @endif>{{ $teams->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-8 mg-t-5 mg-md-t-0">
                                        <div class="input-group file-browser">
                                            <input type="text" class="form-control border-right-0 browse-file"
                                                placeholder="choose" id="textFileSlider" readonly>
                                ...
                                <div class="row row-xs align-items-center mg-b-20">
                                    ...
                                    <div class="col-md-8">
                                        <img src="{{ Storage::url($user->image) }}" alt="..."
                                            class="img-thumbnail w-50" id="image">
                                    </div>
                                </div>
