        ...
        <div class="col-lg-6">
            <div class="card custom-card competency-card">
                <div class="card-header text-center">
                    ...
                    <input type="hidden" name="id" id="competencyid" value="{{ $data->id }}">
                </div>
                <div class="card-body">
                    <div class="row">
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.competency-card').on('click', function(){
                var id = $(this).find('#competencyid').val();

                $('#competencyid-evaluation').val(id).trigger('change');
                $('.select2').prop('disabled', false);
            });

            $('#competencyid-evaluation').on('change', function(){
            ...
            function createRows(response){
                ...
                if(len > 0){
                    for(var i=0; i < len; i++){
                        ...
                        var evaluation_result = response['data'][i].evaluation_result;
                        var evaluation_description = response['data'][i].evaluation_description;
                        ...
                        var tr_str = "<tr>" +
                            ...
                            "<td> <input class='form-control input-sm' type='text' name='result' id='result' value='" + evaluation_result + "'> </td>" +
                            "<td> <textarea class='form-control' name='description' id='description' rows='1' spellcheck='false'>" + evaluation_description + "</textarea> </td>" +
                        "</tr>";
